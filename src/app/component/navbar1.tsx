...
const client = createClient({
  projectId: "15hm7ok6", // Replace with your Sanity project ID
  dataset: "production",
    ...
    <nav className="w-full bg-white shadow-sm">
      ...
      <div className="lg:hidden">
        ...
        <li><Link href="/Contact" className="text-[18px] font-semibold hover:text-blue-500 transition">Contact</Link></li>
                ...
                {!userId ? (
          <>
            <Link href="/sign-in"className="text-[18px] font-semibold hover:text-blue-500 transition">
              Login
            </Link>
            <Link href="/sign-up" className="text-[18px] font-semibold hover:text-blue-500 transition">
              Register
            </Link>
          </>
        ) : (
          <UserButton />
                ...
                <li className="flex flex-row justify-betweent gap-5">
                <a href="/cart" className="text-gray-700 hover:text-blue-500 transition-colors">
            <LucideShoppingCart />
            </a>
            <Link href={''} className="text-[24px] text-gray-700  hover:text-blue-500 transition-colors"><FaRegHeart /> </Link>
